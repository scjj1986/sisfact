...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "Sistema de Facturación Materiales Madero (SisFact) "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
           <td style="width:100%;" class='midnight-blue'>FACTURAR A</td>
        </tr>
		<tr>
           <td style="width:100%;" >
			<?php 
				...
				echo "<b>Doc. Identidad:</b> ".$rw_cliente['docide_cliente'];
				echo "<br><b>Nombre:</b> ".$rw_cliente['nombre_cliente'];
				echo "<br><b>Direcc.:</b> ".$rw_cliente['direccion_cliente'];
				echo "<br><b>Tlf.:</b> ".$rw_cliente['telefono_cliente'];
			?>
