    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $firstname = strtoupper(mysqli_real_escape_string($con,(strip_tags($_POST["firstname"],ENT_QUOTES))));
				$lastname = strtoupper(mysqli_real_escape_string($con,(strip_tags($_POST["lastname"],ENT_QUOTES))));
