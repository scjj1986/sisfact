<?php
	...
	if($action == 'ajax'){
		...
		if ( $_GET['q'] != "" )
		{
		$sWhere.= " and  (clientes.docide_cliente like '%$q%' or clientes.nombre_cliente like '%$q%' or facturas.numero_factura like '%$q%')";
			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="alert-danger">
					<th>#</th>
					<th>Fecha</th>
					<th>Cliente (Doc. Ident. | Nombre)</th>
					<th>Vendedor</th>
					<th>Estado</th>
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><a href="#" data-toggle="tooltip" data-placement="top" title="<i class='glyphicon glyphicon-phone'></i> <?php echo $telefono_cliente;?><br><i class='glyphicon glyphicon-envelope'></i>  <?php echo $email_cliente;?>" ><?php echo $docide." | ".$nombre_cliente;?></a></td>
