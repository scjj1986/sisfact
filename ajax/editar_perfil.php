<?php
	...
	if (empty($_POST['nombre_empresa'])) {
		...
		$cuil=mysqli_real_escape_string($con,(strip_tags($_POST["cuil"],ENT_QUOTES)));
		
		$sql="UPDATE perfil SET nombre_empresa='".$nombre_empresa."', telefono='".$telefono."', email='".$email."', impuesto='".$impuesto."', moneda='".$moneda."', direccion='".$direccion."', ciudad='".$ciudad."', estado='".$estado."', codigo_postal='$codigo_postal', cuil='$cuil' WHERE id_perfil='1'";
