        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 toppad" >
          ...
          <div class="panel panel-danger">
            <div class="panel-heading" style="background-color: #CD2323;">
              <h4 class="panel-title" style="color: white;"><i class='glyphicon glyphicon-cog'></i> Acerca de la Empresa</h4>
            </div>
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-condensed">
                    <tbody>
                      ...
                      <tr>
                        <td>CUIL:</td>
                        <td><input type="text" class="form-control input-sm" name="cuil" value="<?php echo $row["cuil"];?>"></td>
                      </tr>
