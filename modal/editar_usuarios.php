		  ...
		  <div class="modal-body">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="password" class="form-control" id="user_password_new2" name="user_password_new2" placeholder="Contraseña" pattern=".{6,}" title="Contraseña ( min . 6 caracteres)">
				</div>
			  </div>
			  <div class="form-group">
				<label for="user_password_repeat" class="col-sm-3 control-label">Repite contraseña</label>
				<div class="col-sm-8">
				  <input type="password" class="form-control" id="user_password_repeat2" name="user_password_repeat2" placeholder="Repite contraseña" pattern=".{6,}">
				</div>
			  </div>
