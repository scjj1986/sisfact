<?php
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.docide_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.email_cliente, facturas.id_vendedor, facturas.fecha_factura, facturas.condiciones, facturas.estado_factura, facturas.numero_factura";
		...
		if ($count==1)
		{
				...
				$docide_cliente=$rw_factura['docide_cliente'];
...
<html lang="en">
  ...
  <body>
	...
	<div class="panel panel-danger">
		<div class="panel-heading" style="background-color: #CD2323;">
			<h4 style="color: white;"><i class='glyphicon glyphicon-edit'></i> Editar Factura</h4>
		</div>
				  ...
				  <div class="col-md-6">
				  	  <div class="input-group">
						  <span class="input-group-btn">
	                            <button id="bsc_cli" onclick="modalClientes()" class="btn btn-primary glyphicon glyphicon-search" type="button"></button>
	                      </span>
	                      <input disabled type="text" id="txtcli" class="form-control" value="<? echo $docide_cliente.' ; '.$nombre_cliente; ?>" placeholder="Buscar...">
					...
					<div class="col-md-3">
						<input type="text" value="<? echo $telefono_cliente; ?>" class="form-control input-sm" id="tlf_cliente" placeholder="Teléfono" readonly>
					</div>
				 </div>
						<div class="form-group row">
